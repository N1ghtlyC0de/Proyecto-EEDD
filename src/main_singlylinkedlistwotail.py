from linkedListwotail import LinkedListwotail
import time
import random
...
if __name__ == '__main__':
  ...
  list_of_data = LinkedListwotail()
  list_of_compare_prices =  LinkedListwotail()
  for line in data:
    line.strip()
    olx = line.split(", ")
  ...
  def comparePrices(lista, desiredProduct):
  ...
  for item in range(10):
    ...
    comparePrices(list_of_compare_prices, desiredProduct)
